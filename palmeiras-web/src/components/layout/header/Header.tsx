    ...
    <div className="mx-auto max-w-[80%]">
      ...
      {toggle && (
        <>
          ...
          <aside
            className="fixed top-0 right-0 z-20 w-full h-full bg-white dark:bg-[#121212] p-8 sm:w-1/2 xl:w-1/3 sm:rounded-s-[40px] sm:shadow-black dark:sm:shadow-white dark:sm:shadow"
            ref={shoppingCartRef}
          >
